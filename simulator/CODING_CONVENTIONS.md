...
and load scenarios. The deterministic event generator, MQTT device publisher,
API fixture sender, and their executable checks are documented in
[README.md](README.md); broader load scenarios remain future work.
